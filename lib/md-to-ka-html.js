...
function mermaidFlowchartToHtml(source) {
  ...
  return `<table style="border-collapse: collapse; width: 100%; margin-top: 16px;" border="1" cellpadding="8" cellspacing="0"><tbody>
${rows.join('\n')}
</tbody></table>`;
}

const TABLE_BASE_STYLE =
  'border-collapse: collapse; width: 100%; border: 1px solid #d8dde6;';
